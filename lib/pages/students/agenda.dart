...
class _PeriodInfo {
  ...
  _PeriodInfo(this.period, this.upperBound);
}

class _AgendaAppState extends State<AgendaApp> with SingleTickerProviderStateMixin {
  Timer? _timer;
  String _selectedLunchType = "A";
  ...
  void initState() {
    ...
    _timer = Timer.periodic(Duration(seconds: 5), (timer) {
      setState(() {});
      _updateLiveActivity(); // Update Live Activity every 5 seconds
    });
  ...
  // Add this method to start or update the Live Activity
  Future<void> _updateLiveActivity() async {
    ...
    // Calculate period and upperBound as in your build method
    String period = "";
    int upperBound = 0;
    ...
    liveActivities.init(appGroupId: 'group.com.rooseveltconnect.liveactivities');

    final Map<String, dynamic> activityModel = {
      'period': period,
      'minutesLeft': math.min(0, (upperBound - minutes).abs()),
    };
                ...
                Column(
                  ...
                  children: [
                    Transform.translate(
                      ...
                      child: Container(
                        width: MediaQuery.of(context).size.width,
                        height: MediaQuery.of(context).size.height/1.15 - 80,
                        decoration: BoxDecoration(
